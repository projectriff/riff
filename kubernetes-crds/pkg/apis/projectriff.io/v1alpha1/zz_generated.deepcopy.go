...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*TopicBinding).DeepCopyInto(out.(*TopicBinding))
			return nil
		}, InType: reflect.TypeOf(&TopicBinding{})},
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*TopicBindingList).DeepCopyInto(out.(*TopicBindingList))
			return nil
		}, InType: reflect.TypeOf(&TopicBindingList{})},
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*TopicBindingSpec).DeepCopyInto(out.(*TopicBindingSpec))
			return nil
		}, InType: reflect.TypeOf(&TopicBindingSpec{})},
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
			in.(*TopicBindingStatus).DeepCopyInto(out.(*TopicBindingStatus))
			return nil
		}, InType: reflect.TypeOf(&TopicBindingStatus{})},
		conversion.GeneratedDeepCopyFunc{Fn: func(in interface{}, out interface{}, c *conversion.Cloner) error {
...
func (in *InvokerSpec) DeepCopyInto(out *InvokerSpec) {
	*out = *in
	...
	in.TopicBindingTemplate.DeepCopyInto(&out.TopicBindingTemplate)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopicBinding) DeepCopyInto(out *TopicBinding) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopicBinding.
func (in *TopicBinding) DeepCopy() *TopicBinding {
	if in == nil {
		return nil
	}
	out := new(TopicBinding)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TopicBinding) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	} else {
		return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopicBindingList) DeepCopyInto(out *TopicBindingList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]TopicBinding, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopicBindingList.
func (in *TopicBindingList) DeepCopy() *TopicBindingList {
	if in == nil {
		return nil
	}
	out := new(TopicBindingList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TopicBindingList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	} else {
		return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopicBindingSpec) DeepCopyInto(out *TopicBindingSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopicBindingSpec.
func (in *TopicBindingSpec) DeepCopy() *TopicBindingSpec {
	if in == nil {
		return nil
	}
	out := new(TopicBindingSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopicBindingStatus) DeepCopyInto(out *TopicBindingStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopicBindingStatus.
func (in *TopicBindingStatus) DeepCopy() *TopicBindingStatus {
	if in == nil {
		return nil
	}
	out := new(TopicBindingStatus)
