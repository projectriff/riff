...
func TestProxyTransport(t *testing.T) {
	...
	table := map[string]Item{
		"normal": {
			...
			sourceURL:    "http://www.epicformulas.com/logs/log.log",
			transport:    testTransport,
			output:       `<pre><a href="kubelet.log">kubelet.log</a><a href="http://www.foo.com/proxy/node/node1:10250/google.log">google.log</a></pre>`,
		...
		"full document": {
			...
			sourceURL:    "http://www.epicformulas.com/logs/log.log",
			transport:    testTransport,
			output:       `<html><header></header><body><pre><a href="kubelet.log">kubelet.log</a><a href="http://www.foo.com/proxy/node/node1:10250/google.log">google.log</a></pre></body></html>`,
			contentType:  "text/html",
			forwardedURI: "/proxy/node/node1:10250/logs/log.log",
		},
		"trailing slash": {
		...
		"subdir": {
			...
			sourceURL:    "http://www.epicformulas.com/whatever/apt/somelog.log",
		...
		"image": {
			...
			sourceURL:    "http://www.epicformulas.com",
			transport:    testTransport,
			output:       `<pre><img src="kubernetes.jpg"/><img src="http://www.foo.com/proxy/node/node1:10250/kubernetes_abs.jpg"/></pre>`,
			contentType:  "text/html",
			forwardedURI: "/proxy/node/node1:10250/",
		},
		"abs": {
			input:        `<script src="https://google.com/kubernetes.js"/>`,
			sourceURL:    "http://www.epicformulas.com/any/path/",
			transport:    testTransport,
			output:       `<script src="https://google.com/kubernetes.js"/>`,
			contentType:  "text/html",
			forwardedURI: "/proxy/node/node1:10250/any/path/",
		},
		"abs but same host": {
			input:        `<script src="http://www.epicformulas.com/kubernetes.js"/>`,
			sourceURL:    "http://www.epicformulas.com/any/path/",
			transport:    testTransport,
			output:       `<script src="http://www.foo.com/proxy/node/node1:10250/kubernetes.js"/>`,
			contentType:  "text/html",
			forwardedURI: "/proxy/node/node1:10250/any/path/",
		},
		"redirect rel": {
			sourceURL:    "http://www.epicformulas.com/redirect",
			transport:    testTransport,
			redirect:     "/redirected/target/",
			redirectWant: "http://www.foo.com/proxy/node/node1:10250/redirected/target/",
			forwardedURI: "/proxy/node/node1:10250/redirect",
		},
		"redirect abs same host": {
			sourceURL:    "http://www.epicformulas.com/redirect",
			transport:    testTransport,
			redirect:     "http://www.epicformulas.com/redirected/target/",
			redirectWant: "http://www.foo.com/proxy/node/node1:10250/redirected/target/",
			forwardedURI: "/proxy/node/node1:10250/redirect",
		},
		"redirect abs other host": {
			sourceURL:    "http://www.epicformulas.com/redirect",
			transport:    testTransport,
			redirect:     "https://example.com/redirected/target/",
			redirectWant: "https://example.com/redirected/target/",
			forwardedURI: "/proxy/node/node1:10250/redirect",
		},
		"source contains the redirect already": {
			input:        `<pre><a href="kubelet.log">kubelet.log</a><a href="http://www.foo.com/proxy/node/node1:10250/google.log">google.log</a></pre>`,
			sourceURL:    "http://www.foo.com/logs/log.log",
			transport:    testTransport,
			output:       `<pre><a href="kubelet.log">kubelet.log</a><a href="http://www.foo.com/proxy/node/node1:10250/google.log">google.log</a></pre>`,
			contentType:  "text/html",
			forwardedURI: "/proxy/node/node1:10250/logs/log.log",
