...
var map_PriorityClass = map[string]string{
	...
	"metadata":      "Standard object's metadata. More info: https://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata",
...
var map_PriorityClassList = map[string]string{
	...
	"metadata": "Standard list metadata More info: https://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata",
