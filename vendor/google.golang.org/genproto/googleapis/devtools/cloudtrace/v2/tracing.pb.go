...
func (*BatchWriteSpansRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tracing_25bea29412890bc4, []int{0}
}
...
func init() {
	proto.RegisterFile("google/devtools/cloudtrace/v2/tracing.proto", fileDescriptor_tracing_25bea29412890bc4)
}

var fileDescriptor_tracing_25bea29412890bc4 = []byte{
