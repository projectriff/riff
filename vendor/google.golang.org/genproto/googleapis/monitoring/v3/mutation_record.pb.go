...
func (*MutationRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutation_record_909f578c988d9451, []int{0}
}
...
func init() {
	proto.RegisterFile("google/monitoring/v3/mutation_record.proto", fileDescriptor_mutation_record_909f578c988d9451)
}

var fileDescriptor_mutation_record_909f578c988d9451 = []byte{
