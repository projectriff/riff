...
func (*SpanContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_span_context_4c30f2e57596ce1c, []int{0}
}
...
func init() {
	proto.RegisterFile("google/monitoring/v3/span_context.proto", fileDescriptor_span_context_4c30f2e57596ce1c)
}

var fileDescriptor_span_context_4c30f2e57596ce1c = []byte{
