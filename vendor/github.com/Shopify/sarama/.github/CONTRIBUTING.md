...
- You can set `sarama.Logger` to a [log.Logger](https://golang.org/pkg/log/#Logger) instance to capture debug output. Please include it in your issue description.
