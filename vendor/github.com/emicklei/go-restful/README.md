...
- Configurable router:
	...
	- Routing algorithm after [JSR311](https://jsr311.java.net/nonav/releases/1.1/spec/spec.html) that is implemented using (but does **not** accept) regular expressions
