...
func (_m *TopicInformer) Lister() projectriffv1alpha1.TopicLister {
	ret := _m.Called()

	var r0 projectriffv1alpha1.TopicLister
	if rf, ok := ret.Get(0).(func() projectriffv1alpha1.TopicLister); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(projectriffv1alpha1.TopicLister)
		}
	}
