...
func (c *FlowsV1alpha1Client) Flows(namespace string) FlowInterface {
...
func NewForConfig(c *rest.Config) (*FlowsV1alpha1Client, error) {
	...
	return &FlowsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FlowsV1alpha1Client for the given config and
