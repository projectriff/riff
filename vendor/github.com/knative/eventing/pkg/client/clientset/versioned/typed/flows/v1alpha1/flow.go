...
type FlowInterface interface {
	...
	List(opts v1.ListOptions) (*v1alpha1.FlowList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Flow, err error)
	FlowExpansion
}
...
func newFlows(c *FlowsV1alpha1Client, namespace string) *flows {
	return &flows{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *flows) Get(name string, options v1.GetOptions) (result *v1alpha1.Flow, err error) {
...
func (c *flows) List(opts v1.ListOptions) (result *v1alpha1.FlowList, err error) {
...
func (c *flows) Watch(opts v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("flows").
...
func (c *flows) Create(flow *v1alpha1.Flow) (result *v1alpha1.Flow, err error) {
	result = &v1alpha1.Flow{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("flows").
...
func (c *flows) Update(flow *v1alpha1.Flow) (result *v1alpha1.Flow, err error) {
	result = &v1alpha1.Flow{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("flows").
...
func (c *flows) Delete(name string, options *v1.DeleteOptions) error {
...
func (c *flows) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("flows").
...
func (c *flows) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Flow, err error) {
	result = &v1alpha1.Flow{}
