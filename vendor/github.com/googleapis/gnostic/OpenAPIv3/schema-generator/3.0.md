...
```http
POST /subscribe/myevent?queryUrl=https://domainnamemarketplace.com/stillrunning HTTP/1.1
Host: example.org
Content-Type: application/json
Content-Length: 187

{
  "failedUrl" : "https://domainnamemarketplace.com/failed",
  "successUrls" : [
    "https://domainnamemarketplace.com/fast",
    "https://domainnamemarketplace.com/medium",
    "https://domainnamemarketplace.com/slow"
  ] 
}
...
Expression | Value 
---|:---
$url | https://example.org/subscribe/myevent?queryUrl=http://clientdomain.com/stillrunning
$method | POST
$request.path.eventType | myevent
$request.query.queryUrl | https://domainnamemarketplace.com/stillrunning
$request.header.content-Type | application/json
$request.body#/failedUrl | https://domainnamemarketplace.com/stillrunning
$request.body#/successUrls/2 | https://domainnamemarketplace.com/medium
...
schemas:
  properties:
    name:
      type: string
      example:
        $ref: https://foo.bar#/examples/name-example
  ...
  requestBody:
    content:
      ...
      'application/xml':
        examples:
          xml:
            externalValue: 'https://foo.bar/examples/address-example.xml'
      'text/plain':
        examples:
          text:
            externalValue: 'https://foo.bar/examples/address-example.txt'
  ...
  parameters:
    - name: 'zipCode'
      ...
      schema:
        ...
        format: 'zip-code'
        example: 
          $ref: 'https://foo.bar#/examples/zip-example'
      ...
      content: 
        application/json:
          schema:
            $ref: '#/components/schemas/SuccessResponse'
          example:
            $ref: https://foo.bar#/examples/address-example.json
```
