...
import projectriffv1 "github.com/projectriff/riff/kubernetes-crds/pkg/client/listers/projectriff/v1"
...
func (_m *FunctionInformer) Lister() projectriffv1.FunctionLister {
	ret := _m.Called()

	var r0 projectriffv1.FunctionLister
	if rf, ok := ret.Get(0).(func() projectriffv1.FunctionLister); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(projectriffv1.FunctionLister)
		}
	}
