...
func (_m *AutoScaler) InformFunctionReplicas(function autoscaler.LinkId, replicas int) {
	_m.Called(function, replicas)
}

// Propose provides a mock function with given fields:
func (_m *AutoScaler) Propose() map[autoscaler.LinkId]int {
	ret := _m.Called()

	var r0 map[autoscaler.LinkId]int
	if rf, ok := ret.Get(0).(func() map[autoscaler.LinkId]int); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[autoscaler.LinkId]int)
		}
	}
...
func (_m *AutoScaler) SetDelayScaleDownPolicy(_a0 func(autoscaler.LinkId) time.Duration) {
	_m.Called(_a0)
}

// SetMaxReplicasPolicy provides a mock function with given fields: _a0
func (_m *AutoScaler) SetMaxReplicasPolicy(_a0 func(autoscaler.LinkId) int) {
	_m.Called(_a0)
}

// StartMonitoring provides a mock function with given fields: topic, function
func (_m *AutoScaler) StartMonitoring(topic string, function autoscaler.LinkId) error {
	ret := _m.Called(topic, function)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, autoscaler.LinkId) error); ok {
...
func (_m *AutoScaler) StopMonitoring(topic string, function autoscaler.LinkId) error {
	ret := _m.Called(topic, function)
