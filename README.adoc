...
If you want to run the current development version of riff read the link:Development-Helm-install.adoc[Helm chart] doc. You an also link:#manual[build and deploy riff manually], this is the best option if you want to modify the riff components.
