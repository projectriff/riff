...
func Init() (*cobra.Command, *options.InitOptions) {
	...
	initCmd.PersistentFlags().StringVar(&initOptions.RiffVersion, "invoker-version", utils.DefaultValues.RiffVersion, "the version of the function invoker to use when building containers")
