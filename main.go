...
var (
	...
	manifests = map[string]*core.Manifest{
		...
		"stable": {
			...
			Namespace: []string{
				// TODO update to a stable version before releasing riff
				"https://storage.googleapis.com/projectriff/riff-buildtemplate/riff-cnb-buildtemplate-0.2.0-snapshot.yaml",
			},
		},
