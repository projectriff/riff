...
func FunctionCreate(fcTool *core.Client) *cobra.Command {
	...
	invokers := map[string]string{
		"java":            "https://github.com/projectriff/java-function-invoker/raw/v0.1.0/java-invoker.yaml",
		"java-invoker":    "https://github.com/projectriff/java-function-invoker/raw/v0.1.0/java-invoker.yaml",
