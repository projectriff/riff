...
func TestHandlerListCommand(t *testing.T) {
	handlersName := "test-handlers"
	handlerOtherName := "test-other-handlers"
...
test-handlers   <unknown>   <unknown>   <empty>   <unknown>   <unknown>
`,
		},
		{
...
default           test-handlers         <unknown>   <unknown>   <empty>   <unknown>   <unknown>
other-namespace   test-other-handlers   <unknown>   <unknown>   <empty>   <unknown>   <unknown>
`,
		},
		{
