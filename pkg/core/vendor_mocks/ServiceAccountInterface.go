...
func (_m *ServiceAccountInterface) Create(_a0 *v1.ServiceAccount) (*v1.ServiceAccount, error) {
	...
	if rf, ok := ret.Get(0).(func(*v1.ServiceAccount) *v1.ServiceAccount); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*v1.ServiceAccount) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ServiceAccountInterface) CreateToken(name string, tr *authenticationv1.TokenRequest) (*authenticationv1.TokenRequest, error) {
	ret := _m.Called(name, tr)

	var r0 *authenticationv1.TokenRequest
	if rf, ok := ret.Get(0).(func(string, *authenticationv1.TokenRequest) *authenticationv1.TokenRequest); ok {
		r0 = rf(name, tr)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, *authenticationv1.TokenRequest) error); ok {
		r1 = rf(name, tr)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ServiceAccountInterface) Get(name string, options metav1.GetOptions) (*v1.ServiceAccount, error) {
	...
	var r0 *v1.ServiceAccount
	if rf, ok := ret.Get(0).(func(string, metav1.GetOptions) *v1.ServiceAccount); ok {
		r0 = rf(name, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1.ServiceAccount)
...
func (_m *ServiceAccountInterface) List(opts metav1.ListOptions) (*v1.ServiceAccountList, error) {
	...
	if rf, ok := ret.Get(0).(func(metav1.ListOptions) *v1.ServiceAccountList); ok {
		r0 = rf(opts)
	} else {
		if ret.Get(0) != nil {
...
func (_m *ServiceAccountInterface) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1.ServiceAccount, error) {
	...
	var r0 *v1.ServiceAccount
	if rf, ok := ret.Get(0).(func(string, types.PatchType, []byte, ...string) *v1.ServiceAccount); ok {
