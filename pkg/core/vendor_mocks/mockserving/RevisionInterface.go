...
func (_m *RevisionInterface) Create(_a0 *v1alpha1.Revision) (*v1alpha1.Revision, error) {
	ret := _m.Called(_a0)

	var r0 *v1alpha1.Revision
	if rf, ok := ret.Get(0).(func(*v1alpha1.Revision) *v1alpha1.Revision); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.Revision)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*v1alpha1.Revision) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *RevisionInterface) Get(name string, options v1.GetOptions) (*v1alpha1.Revision, error) {
	...
	var r0 *v1alpha1.Revision
	if rf, ok := ret.Get(0).(func(string, v1.GetOptions) *v1alpha1.Revision); ok {
		r0 = rf(name, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.Revision)
...
func (_m *RevisionInterface) List(opts v1.ListOptions) (*v1alpha1.RevisionList, error) {
	ret := _m.Called(opts)

	var r0 *v1alpha1.RevisionList
	if rf, ok := ret.Get(0).(func(v1.ListOptions) *v1alpha1.RevisionList); ok {
		r0 = rf(opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.RevisionList)
		}
	}
...
func (_m *RevisionInterface) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1alpha1.Revision, error) {
	...
	var r0 *v1alpha1.Revision
	if rf, ok := ret.Get(0).(func(string, types.PatchType, []byte, ...string) *v1alpha1.Revision); ok {
...
func (_m *RevisionInterface) Update(_a0 *v1alpha1.Revision) (*v1alpha1.Revision, error) {
	ret := _m.Called(_a0)
