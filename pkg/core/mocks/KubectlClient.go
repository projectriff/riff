...
func (_m *KubectlClient) NamespaceInit(manifests map[string]*crd.Manifest, options core.NamespaceInitOptions) error {
	ret := _m.Called(manifests, options)

	var r0 error
	if rf, ok := ret.Get(0).(func(map[string]*crd.Manifest, core.NamespaceInitOptions) error); ok {
