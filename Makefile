...
gen-mocks: check-mockery check-jq
	...
	GO111MODULE=on mockery -output pkg/crd/mocks                     -outpkg mocks        -dir pkg/crd                                                                                            -name Client
	...
	GO111MODULE=on mockery -output pkg/core/vendor_mocks/mockextensions     -outpkg mockextensions      -dir $(call source_of,k8s.io/apiextensions-apiserver)/pkg/client/clientset/clientset                    -name Interface
	GO111MODULE=on mockery -output pkg/core/vendor_mocks/mockextensions     -outpkg mockextensions      -dir $(call source_of,k8s.io/apiextensions-apiserver)/pkg/client/clientset/clientset/typed/apiextensions/v1beta1 -name ApiextensionsV1beta1Interface
	GO111MODULE=on mockery -output pkg/core/vendor_mocks/mockextensions     -outpkg mockextensions      -dir $(call source_of,k8s.io/apiextensions-apiserver)/pkg/client/clientset/clientset/typed/apiextensions/v1beta1 -name CustomResourceDefinitionInterface
